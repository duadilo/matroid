...
Widget _buildApp() => MaterialApp(
      ...
      home: const Scaffold(body: MarkdownContent()),
    );
...
void main() {
  ...
  testWidgets('Markdown preview widget is present', (tester) async {
    await tester.pumpWidget(_buildApp());
    await tester.pump();
  ...
  testWidgets('Markdown chip label is shown', (tester) async {
    await tester.pumpWidget(_buildApp());
    await tester.pump();

    expect(find.text('Markdown'), findsAtLeastNWidgets(1));
  });
}
